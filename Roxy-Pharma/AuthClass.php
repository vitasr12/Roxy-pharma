...

{
    ...
    public function register($user, $nama, $email, $password)

    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO login(user,nama, email, password) VALUES(:user, :nama, :email, :pass)");
...

    {
        ...
        try {
            ...
            $stmt = $this->db->prepare("SELECT * FROM login WHERE email = :email");
