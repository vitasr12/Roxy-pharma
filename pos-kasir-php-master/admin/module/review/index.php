...
                            <button type="submit" class="btn btn-primary" name="submitted" value="simpan">Save</button>
                            <button type="reset" class="btn btn-secondary" onclick="self.history.back()">Close</button>
                            </div>
                        </div>
              </form>
              <?php 
